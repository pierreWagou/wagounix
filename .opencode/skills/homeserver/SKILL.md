...
|---|---|
| Local device queries `vault.wagou.fr` | AdGuard Home rewrite -> `192.168.68.65` (direct, no Cloudflare roundtrip) |
| Remote device queries `vault.wagou.fr` | Cloudflare DNS -> Cloudflare Tunnel -> Beelink |
