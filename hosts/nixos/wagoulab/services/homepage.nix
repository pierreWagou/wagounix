      ...
      "Services" = [
        {
          "Vaultwarden" = {
            ...
            siteMonitor = "http://host.containers.internal:${toString host.vaultwardenPort}";
          };
        }
        {
          "OpenCloud" = {
            ...
            siteMonitor = "http://host.containers.internal:${toString host.opencloudPort}";
          };
        }
        {
          "Immich" = {
            ...
            siteMonitor = "http://host.containers.internal:${toString host.immichPort}";
            widget = {
              type = "immich";
              url = "http://host.containers.internal:${toString host.immichPort}";
      ...
      "Media" = [
        {
          "Home Assistant" = {
            ...
            siteMonitor = "http://host.containers.internal:${toString host.homeAssistantPort}";
          };
        }
        {
          "Jellyfin" = {
            ...
            siteMonitor = "http://host.containers.internal:${toString host.jellyfinPort}";
            widget = {
              type = "jellyfin";
              url = "http://host.containers.internal:${toString host.jellyfinPort}";
      ...
      "Infrastructure" = [
        {
          "AdGuard Home" = {
            ...
            siteMonitor = "http://host.containers.internal:${toString host.adguardWebPort}";
            widget = {
              type = "adguard";
              url = "http://host.containers.internal:${toString host.adguardWebPort}";
